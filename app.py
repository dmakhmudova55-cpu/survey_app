...
# Max score = 20 questions × 3 points = 60
psych_states = {
    "Very low adoption and minimal benefits": (0, 10),
    "Low adoption and some benefits": (11, 20),
    "Moderate adoption and moderate benefits": (21, 35),
    "High adoption and high benefits": (36, 50),
    "Very high adoption and maximum benefits": (51, 60)
}
